...
#from tensorflow import Dense, Dropout,Layers
nltk.download("punkt")
...
dictionnaireDintentions = {"joueurs_equipe_france" : [
    {"tag" : "ATTAQUANTS",
     "patterns" : ["Marcus Thuram", "Wissam Ben Yedder", "Randal Kolo Muani", "Karim Benzema", "Ousmane Dembélé","Kylian Mbappé", "Olivier Giroud"],
     "reponses" : ["Marcus Thuram", "Wissam Ben Yedder", "Randal Kolo Muani", "Karim Benzema", "Ousmane Dembélé","Kylian Mbappé", "Olivier Giroud"]},
     {"tag" : "MILIEUX",
     "patterns" : ["Eduardo Camavinga", "Paul Pogba","Antoine Griezmann","Aurélien Tchouameni","Kingsley Coman","Thomas Lemar","Mattéo Guendouzi","Adrien Rabiot","Florian Thauvin","Jordan Veretout"
     ,"Youssouf Fofana"],
     ...
     ,"Youssouf Fofana"]},
     {"tag" : "DÉFENSEURS",
     "patterns" : ["Axel Disasi", "Benjamin Pavard", "William Saliba","Ibrahima Konaté","Raphaël Varane","Jules Koundé","Dayot Upamecano","Lucas Digne","Léo Dubois","Clément Lenglet"
     ...
     ,"Lucas Hernández","Samuel Umtiti","Theo Hernández"]},
     {"tag" : "GARDIENS",
     "patterns" : ["Hugo Lloris", "Steve Mandanda", "Mike Maignan","Alphonse Aréola"],
...
for idx, doc in enumerate(doc_X):
    bow = []
    text = wnl.lemmatizer.lemmatize(doc.lower())
    for word in words:
